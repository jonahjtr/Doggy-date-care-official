  ...
  return (
    <Link to={"/dog-profile"}>
      ...
      >
        ...
        <div className="border text-xl max-h-[14vh]  sm:text-2xl lg:text-4xl text-white rounded-e-xl w-2/3 bg-primary h-[100px] lg:h-[130px] flex pl-8 lg:pl-12 items-center text-ellipsis  overflow-hidden">
          {dog_name}
        </div>
      </div>
    </Link>
