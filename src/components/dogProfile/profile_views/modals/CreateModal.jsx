...
const CreateModal = (props) => {
  ...
  return (
    <div className="w-full h-full grid grid-cols-[25%_50%_25%]">
      ...
      {isCardVisible && (
        <div className="fixed flex-col max-h-[90vh] w-max min-w-[50%] items-end top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-darkGreen p-4 rounded-lg shadow-md z-20">
